...
const QuestionCard = ({ q, index, onUpdate, onDelete, editable = true }) => {
  ...
  return (
    <div className="bg-purple-900 rounded-xl p-6 text-white space-y-6 shadow-lg">
      <textarea
        value={q.text}
        onChange={handleTextChange}
        placeholder="Escriba la pregunta aquí"
        disabled={!editable}
        className={`w-full h-32 bg-purple-800 p-4 rounded-xl text-lg resize-none placeholder-white focus:outline-none ${
